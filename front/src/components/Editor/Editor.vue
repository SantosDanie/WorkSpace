<template>
	<div class="editor-workPage lotion mx-auto my-5 font-sans text-base" v-if="props.page" ref="editor">
		...
		<h1 id="title" ref="title" :contenteditable="!props.readonly" spellcheck="false" data-ph="Untitled"
			...
			class="focus:outline-none focus-visible:outline-none text-5xl font-bold mb-3"
...
<script setup lang="ts">
	...
	document.querySelector('#blocks')?.addEventListener('mouseup', (event:MouseEvent) => {
...
<style lang="scss">
	#blocks				{ height: 100%; }
	.editor-workPage	{ padding: 0 75px; }
</style>